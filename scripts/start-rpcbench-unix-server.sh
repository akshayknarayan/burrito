...
sudo docker exec -e RUST_LOG=info,rpcbench=trace,bertha=trace,tls-tunnel=trace,burrito-localname-ctl=trace rpcbench-srv /server --unix-addr=/burrito/relhc -o /server.trace "${@:2}"

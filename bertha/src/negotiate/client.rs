...
pub fn negotiate_client<'c, C, A, S>(
    stack: S,
    cn: C,
    addr: A,
...
pub fn negotiate_client_fetch_nonce<'c, C, A, S>(
    stack: S,
    cn: C,
    addr: A,
...
pub fn negotiate_client_fixed_stack<'c, C, A, S>(
    mut stack: S,
    cn: C,
    addr: A,
...
pub fn negotiate_client_nonce<'c, C, A, S>(
    stack: S,
    cn: C,
    nonce: StackNonce,
    addr: A,
